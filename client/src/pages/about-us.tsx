  ...
  return (
    <div className={theme}>
      ...
      <div className="container mx-auto px-4 py-16">
        <Card className={`mb-12 ${theme === "dark" ? "dark:bg-gray-800 dark:text-white" : "bg-white text-gray-900"}`}>
          <CardHeader className={theme === "dark" ? "dark:text-gray-100" : "text-gray-900"}>
        ...
        <Card className={`mb-12 ${theme === "dark" ? "dark:bg-gray-800" : "bg-gray-50"}`}>
          <CardHeader className={theme === "dark" ? "dark:text-gray-100" : "text-gray-900"}>
            <CardTitle className="text-3xl font-semibold">
              Our Mission
            </CardTitle>
        ...
        <Card className={theme === "dark" ? "dark:bg-gray-800 dark:text-white" : "bg-white text-gray-900"}>
          <CardHeader className={theme === "dark" ? "dark:text-gray-100" : "text-gray-900"}>
            <CardTitle className="text-3xl font-semibold">
              Objectives and Purpose
            </CardTitle>
          </CardHeader>
          <CardContent className={theme === "dark" ? "dark:text-gray-300" : "text-gray-700"}>
