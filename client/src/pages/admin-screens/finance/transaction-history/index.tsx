...
import { fetchTransactions, saveTransactions, getStoredTransactions } from "@/api/transactionApi";
...
export default function TransactionHistory() {
  ...
  // Update
  const handleEditTransaction = async (transaction: typeof editingTransaction) => {
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-gray-900' : 'bg-gray-100'}`}>
      <div className={`${theme === 'dark' ? 'bg-blue-900' : 'bg-blue-600'} pt-24 pb-32 px-4 sm:px-6 lg:px-8`}>
