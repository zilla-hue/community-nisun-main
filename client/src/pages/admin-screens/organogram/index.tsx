...
export default function EmployeeManagement() {
  ...
  const confirmDelete = async () => {
    if (employeeToDelete) {
      try {
        const updatedEmployees = deleteEmployeeFromTree(employees, employeeToDelete);
        await handleSaveEmployees(updatedEmployees);
        setEmployees(updatedEmployees);
      } catch (error) {
  ...
  const handleSelectAll = (checked: boolean) => {
    if (checked) {
      ...
      setSelectedEmployees(employees.map((e) => e.id || '').filter(id => id !== ''));
    } else {
  ...
  const renderEmployeeRows = (
    ...
    return employees.flatMap((employee) => [
      <TableRow key={employee.id || crypto.randomUUID()} 
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              and their subordinates from the organization.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <AlertDialog open={isBulkDeleteDialogOpen} onOpenChange={setIsBulkDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Are you sure?</AlertDialogTitle>
            <AlertDialogDescription>
              This action cannot be undone. This will permanently delete {selectedEmployees.length} selected employees
              and their subordinates from the organization.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
