      ...
      const mockArticles: NewsArticle[] = [
        {
          ...
          content: "The annual cultural festival organized by Ndi Igbo Sunderland was a resounding success, showcasing the rich traditions and customs of the Igbo people...",
          date: "2023-07-15"
        },
        {
          id: 2,
          ...
          content: "Ndi Igbo Sunderland has launched a new community outreach program designed to provide support and resources to local families in need...",
          date: "2023-06-22"
        },
