  ...
  return (
    <div className={theme}>
      ...
      <main className="mx-auto px-4 py-12 mt-20">
        ...
        <section className={`py-16 px-8 rounded-3xl mb-16 container ${
          theme === "dark" ? "bg-gray-800/50 text-gray-100" : "bg-amber-50 text-gray-900"
        }`}>
        ...
        <Card className={`p-8 rounded-3xl container ${
