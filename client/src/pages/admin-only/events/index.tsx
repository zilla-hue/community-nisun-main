...
import { PlusIcon, MapPinIcon, CalendarIcon, EditIcon, TrashIcon } from "lucide-react";
...
function EventManager() {
  ...
  const handleEventSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    if (currentEvent && currentEvent.title && currentEvent.date && currentEvent.venue) {
      if (currentEvent.id) {
        ...
        setEvents([
          ...events,
          {
            ...currentEvent,
            id: events.length + 1,
            image: currentEvent.image || "/placeholder.svg?height=400&width=400",
          },
        ]);
      }
      setIsEventDialogOpen(false);
      setCurrentEvent(null);
      toast.success(currentEvent.id ? "Event updated successfully" : "Event added successfully");
    } else {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 mt-16"> {/* Added mt-16 for top margin */}
