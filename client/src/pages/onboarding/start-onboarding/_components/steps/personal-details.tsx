  ...
  return (
    <>
      <div className="flex justify-end">
        <h1 className="mt-4 mb-2 items-center font-semibold text-sm">PERSONAL DETAILS (1 of 3)</h1>
      </div>
      <Separator />
      <form className="space-x-6" onSubmit={handleSubmit(onHandleFormSubmit)}>
        <div className="flex flex-col gap-1">
          <div className="py-2">
            ...
            <Input required id="dob" max={maxDate} type="date" {...register("birth_date")} title="You must be above 18 to proceed." />
          </div>
          ...
          <div className="py-2">
            ...
            <Textarea required id="address" placeholder="10 Cambridge Street, London" {...register("address")} />
          </div>
          <div className="py-2">
            <Label htmlFor="postcode">Postcode</Label>
            <Input id="postcode" type="text" placeholder="LU1 9QB" {...register("postcode")} />
          </div>
          <div className="py-2">
            <Label htmlFor="nationality">Nationality</Label>
            <Input required id="nationality" type="text" placeholder="e.g. Nigerian" {...register("nationality")} />
          </div>
            ...
            {selectedState && (
              <div className="mt-2">
                ...
                <select
                  ...
                  {localGovernmentAreas[selectedState as keyof typeof localGovernmentAreas].map((lga, index) => (
          ...
          <div className="py-2">
            ...
            <Input required id="occupation" type="text" placeholder="e.g. Engineer" {...register("occupation")} />
          </div>
