...
export async function sendSpouseRequestAction(senderId: string, receiverId: string) {
  try {
...
export async function getPendingSpouseRequestsAction(userId: string): Promise<SpouseRequest[]> {
